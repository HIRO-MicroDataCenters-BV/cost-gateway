...
class CostSettingsTest(AsyncTestFixture):
    def test_load_settings_with_cost(self) -> None:
        ...
        self.assertEqual(settings.cost.sources["energy"].min_cost, -0.05)  # type: ignore[attr-defined]
        self.assertEqual(settings.cost.sources["energy"].max_cost, 0.3)  # type: ignore[attr-defined]
